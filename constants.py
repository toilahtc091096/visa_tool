...
VIETNAMESE_COMPANY_NAMES = (
    ...
    "VNG Corporation",
    "CMC Corporation",
    "Cong ty TNHH Thuong mai Dich vu An Phat",
    "Cong ty TNHH San xuat va Thuong mai Minh Long",
    "Cong ty TNHH Co khi Xay dung Tien Dat",
    "Cong ty TNHH MTV Phat Trien Dong A",
    "Cong ty TNHH MTV Dich vu Van tai Hoa Binh",
    "Cong ty Co phan Dau tu va Phat trien Viet Hung",
    "Cong ty Co phan Thuong mai va Dich vu Hoang Gia",
    "Cong ty Co phan Cong nghe So Dai Viet",
)
