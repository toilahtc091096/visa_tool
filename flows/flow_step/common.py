...
def build_flow_context(**kwargs):
    ...
    ctx.work_from = kwargs.get("work_from", "")
    ctx.work_to = kwargs.get("work_to", "")
    ctx.employer_name = kwargs.get("employer_name", "")
    ctx.employer_address = kwargs.get("employer_address", "")
    ctx.employer_phone = kwargs.get("employer_phone", "")
    ctx.supervisor_name = kwargs.get("supervisor_name", "")
    ctx.supervisor_mobile = kwargs.get("supervisor_mobile", "")
    ctx.position = kwargs.get("position", "")
    ctx.duty = kwargs.get("duty", "")
    ctx.name_of_institute = kwargs.get("name_of_institute", "")
    ctx.diploma_degree = kwargs.get("diploma_degree", "")
